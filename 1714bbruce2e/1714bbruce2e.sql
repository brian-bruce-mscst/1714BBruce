...
SELECT Building.BuildingName, Apartment.ApartmentNum, Apartment.Rent, 
Apartment.SquareFeet * 0.9 + 100 * Apartment.Bathrooms AS [Estimated Rent], Apartment.Rent - (Apartment.SquareFeet * 0.9
                  + 100 * Apartment.Bathrooms) AS [Rent - Estimated Rent]
FROM     Building INNER JOIN
                  Apartment ON Building.BuildingId = Apartment.BuildingId
WHERE  (Building.City = N'Red Wing')
